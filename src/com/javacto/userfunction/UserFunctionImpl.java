package com.javacto.userfunction;
import com.javacto.useraction.UserAction;
import com.javacto.userservice.*;
import com.javacto.userservice.courserequirements.CourseRequirements;
...
public class UserFunctionImpl implements UserFunction {
        ...
        while (true) {
            ...
            if (validChoice) {
                ...
                if (booleanTrain.toLowerCase().equals("yes")) {
                    UserFunctionImpl.trainBoolean = true;
                    UserFunctionImpl.trainChoice = choice;
                }
                break Choice;
            } else {
    ...
    public void getTraining() {
        if (UserFunctionImpl.trainBoolean) {
            ...
            for (int i = 0; i < UserAction.userData.size(); i++) {
                ...
                if (UserFunctionImpl.trainChoice.equals(info[0])) {
            ...
            new UserFunctionImpl().writeFile(modifiedUserData);
